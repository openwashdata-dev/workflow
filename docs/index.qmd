...
3. **Open RStudio IDE**
    ...
    15.  Write documentation in `\R` folder using #[[{roxygen}]] comments
        ...
        - Watch out
            - Function overwrites current content. Copy title and description. 
    ...
    17.  Add, commit and push all changes to GitHub 
...
use_author(
  ...
  comment = c(ORCID = "0000-0003-2196-5015")
    ...
    20.  Use `devtools` to load, document, check, and install
...
4. **Open Zenodo**
    ...
    -  Open the entry on Zenodo
        -  Click on Edit
        -  Remove text under Additional Notes and replace with GitHub pages link, e.g.
            - Visit the website of this dataset for instructions how to use it: https://openwashdata.github.io/fsmglobal/
        -  Change upload type
